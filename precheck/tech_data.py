...
valid_layers_ihp_sg13g2 = [
    ...
    "pSD.drawing", "nSD.drawing", "nSD.block", "SalBlock.drawing", "ThickGateOx.drawing", "Cont.drawing", "Metal1.drawing",
    "Metal1.label", "Metal1.nofill", "Metal1.pin", "Metal1.slit", "Metal1.text", "Metal1.res", "Via1.drawing",
...
def analog_pin_rects(tech: str, uses_vapwr: bool):
    if tech == "sky130A":
