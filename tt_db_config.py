...
def getParser():
    ...
    defaults.add_argument('--project', metavar='PROJNAME', type=str, 
                          help='Set the default project on boot')

    defaults.add_argument('--mode', metavar="I/O MODE", type=str, 
                          choices=['SAFE', 'ASIC_RP_CONTROL', 'ASIC_MANUAL_INPUTS'])
    
    
    project = subparsers.add_parser(
        CommandProject,
        help='Project overrides'
    )
...
class ConfigFile:
    ...
    def set_default_mode(self, mode:str):
        self.updater['DEFAULT']['mode'] = name
